...
export default function AdminLogin() {
  ...
  const loginMutation = useMutation({
    ...
    onError: (error: Error) => {
      // Check if session verification was lost
      if (error.message.includes("Secret code verification required first")) {
        setSecretCodeVerified(false);
        setSecretCode("");
        toast({
          title: "Session Expired",
          description: "Please verify the secret code again.",
          variant: "destructive",
        });
        return;
      }
