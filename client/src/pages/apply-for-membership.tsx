...
const membershipTypeOptions = [
  { value: "student", label: "Student", normal: 1500, special: 750 },
  { value: "individual", label: "Entrepreneur / Individual", normal: 3000, special: 1500 },
  { value: "corporate", label: "Business / Corporate", normal: 10000, special: 5000 },
  { value: "institutional", label: "Institution / Organization", normal: 7500, special: 3750 },
];
...
export function ApplyForMembership() {
  ...
  const currentPrice = formData.membershipType ? membershipPricing[formData.membershipType].special : 0;
  const normalPrice = formData.membershipType ? membershipPricing[formData.membershipType].normal : 0;
