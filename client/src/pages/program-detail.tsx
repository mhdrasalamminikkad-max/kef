        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            <div className="lg:col-span-2">
              ...
              {/* Banner Image - Show actual image or placeholder */}
              <motion.div
                initial={{ opacity: 0, y: 20 }}
                whileInView={{ opacity: 1, y: 0 }}
                viewport={{ once: true }}
              ...
              >
                {program.bannerImage ? (
                  ...
                  <div className={`w-full h-64 rounded-lg shadow-lg bg-gradient-to-br ${gradientClass} flex items-center justify-center`}>
                    <div className="text-center text-white">
                      <IconComponent className="w-24 h-24 mx-auto mb-4 opacity-80" />
                      <p className="text-lg font-semibold opacity-90">{program.title}</p>
                    </div>
                  </div>
                )}
              </motion.div>
              ...
              >
                <Card className="overflow-visible">
                  <CardContent className="p-6">
                    ...
                    {/* Registration button for live and upcoming programs */}
                    {(program.programStatus === 'live' || program.programStatus === 'upcoming') && (
                      <div className="mt-6 pt-6 border-t border-border">
                        {program.registerUrl ? (
                          // External registration URL set in admin panel → open in new tab
                          <a href={program.registerUrl} target="_blank" rel="noopener noreferrer">
                          ...
                          // No external URL → use the internal registration form
