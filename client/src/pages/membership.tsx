                        ...
                        <div className="border-t pt-6 mt-6">
                          ...
                          <div className="bg-muted/50 rounded-xl p-4 sm:p-6 mb-6">
                            <div className="flex flex-col sm:flex-row justify-between items-center gap-4 mb-6">
                              <div className="text-center sm:text-left">
                                <p className="text-sm text-muted-foreground mb-1">Total Membership Fee</p>
                            ...
                            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 mb-6">
                              <div className="p-3 bg-background rounded-lg border flex flex-col justify-between group relative overflow-hidden">
                                <div className="absolute inset-0 bg-primary/5 opacity-0 group-hover:opacity-100 transition-opacity" />
                                <div className="flex justify-between items-start mb-1 relative">
                                  <span className="text-[10px] uppercase font-bold text-muted-foreground tracking-wider">UPI ID</span>
                                  <button 
                                    type="button"
                                ...
                                <p className="text-sm font-mono font-semibold break-all pr-4 relative">{UPI_ID}</p>
                              </div>
                              <div className="p-3 bg-background rounded-lg border flex flex-col justify-between group relative overflow-hidden">
                                <div className="absolute inset-0 bg-primary/5 opacity-0 group-hover:opacity-100 transition-opacity" />
                                <div className="flex justify-between items-start mb-1 relative">
                                  <span className="text-[10px] uppercase font-bold text-muted-foreground tracking-wider">Payee Name</span>
                                  <button 
                                    type="button"
                                    onClick={() => copyToClipboard(PAYEE_NAME, "Payee Name")}
                                    className="p-1 hover:bg-muted rounded transition-colors"
                                    title="Copy Name"
                                  >
                                    <Copy className="w-3.5 h-3.5 text-primary" />
                                ...
                                <p className="text-sm font-semibold truncate relative">{PAYEE_NAME}</p>
                              </div>
                            </div>

                            <div className="space-y-3">
                              <p className="text-xs font-semibold text-muted-foreground uppercase tracking-widest text-center">Open in UPI App</p>
                              <div className="flex flex-wrap justify-center gap-2">
                                {upiApps.map((app) => (
                                  <Button
                                    ...
                                    variant="outline"
                                    size="sm"
                                    className="h-10 px-4 rounded-full border-muted-foreground/20 hover:border-primary/50 transition-all hover:shadow-md"
                          ...
                          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-6">
                            <div className="space-y-2">
                              ...
                              />
                              <p className="text-[10px] text-muted-foreground">Find this in your payment confirmation</p>
                            </div>
                            <div className="space-y-2">
                              <Label htmlFor="payerUpiId">Your UPI ID (Optional)</Label>
                              <Input
                                id="payerUpiId"
