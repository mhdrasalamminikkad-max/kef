...
// OPTIMIZED: Memoized ProgramCard with reduced animation
          ...
          <CardContent className="p-6">
            <div className="flex items-start gap-4">
              ...
              <div className="flex-1 min-w-0">
                ...
                <div className="h-1 w-16 bg-gradient-to-r from-primary to-transparent rounded-full mb-3" />
...
export default function Programs() {
  ...
  // OPTIMIZED: Memoize filtered lists to prevent unnecessary recalculations
  const { livePrograms, upcomingPrograms, pastPrograms } = useMemo(() => ({
    livePrograms: programsList?.filter(p => p.programStatus === 'live') || [],
    upcomingPrograms: programsList?.filter(p => p.programStatus === 'upcoming') || [],
    pastPrograms: programsList?.filter(p => p.programStatus === 'past') || [],
  }), [programsList]);
