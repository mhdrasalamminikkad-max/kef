...
import ProgramRegistrationPage from "@/pages/program-registration";
        ...
        <Route>
          <Layout>
            <Switch>
              ...
              <Route path="/programs/:id/register" component={({ id }: { id: string }) => <ProgramRegistrationPage programId={id} />} />
